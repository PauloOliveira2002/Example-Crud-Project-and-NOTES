...
<br><br>
    <form method="POST" class="container" action="<?php echo e(url('turmas/' . $turma->id)); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        ...
        <input
            ...
            value="<?php echo e($turma -> descricao); ?>"
            class="form-control
...
<?php /**PATH C:\Users\Paulo\Desktop\curso\SKILLS\TREINO\SKILLS\resources\views/components/turmas/turma-form-edit.blade.php ENDPATH**/ ?>